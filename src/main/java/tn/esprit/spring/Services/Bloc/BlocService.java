...
public class BlocService implements IBlocService {
    ...
    public List<Bloc> findBlocsWithCapacityGreaterThan(long capacity) {
        return repo.findBlocsWithCapacityGreaterThan(capacity);
    }

    // New Method 2: Find blocs grouped by capacity with a specific type of room
    public List<Bloc> findBlocsByTypeChambreGroupedByCapacity(TypeChambre typeChambre) {
        return repo.findBlocsByTypeChambreGroupedByCapacity(typeChambre);
    }
}
